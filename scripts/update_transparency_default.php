<?php
/**
 * Script om transparantie voor alle bestaande layers op TRUE te zetten
 * Run: php scripts/update_transparency_default.php
 */

// Pad naar database
$dbPath = dirname(__DIR__) . '/data/posters.db';
