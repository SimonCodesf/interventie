    ...
    try {
        ...
        for ($i = 1; $i <= 8; $i++) {
            $layerData = [
                ...
                'text_enabled' => (int)($_POST["layer_{$i}_text_enabled"] ?? 0) === 1,
                'text_random_style' => (int)($_POST["layer_{$i}_text_random"] ?? 0) === 1,
                'text_random_font' => (int)($_POST["layer_{$i}_text_random_font"] ?? 0) === 1,
                'text_random_color' => (int)($_POST["layer_{$i}_text_random_color"] ?? 0) === 1,
                'text_random_outline' => (int)($_POST["layer_{$i}_text_random_outline"] ?? 0) === 1,
                'text_random_effect' => (int)($_POST["layer_{$i}_text_random_effect"] ?? 0) === 1,
                'text_random_effect_color' => (int)($_POST["layer_{$i}_text_random_effect_color"] ?? 0) === 1,
                'text_random_3d' => (int)($_POST["layer_{$i}_text_random_3d"] ?? 0) === 1,
                'text_random_size' => (int)($_POST["layer_{$i}_text_random_size"] ?? 0) === 1,
                'text_random_align' => (int)($_POST["layer_{$i}_text_random_align"] ?? 0) === 1,
                'text_content' => trim($_POST["layer_{$i}_text_content"] ?? ''),
                'text_font_family' => $_POST["layer_{$i}_text_font_family"] ?? '"Bebas Neue", sans-serif',
                'text_font_size' => (int)($_POST["layer_{$i}_text_font_size"] ?? 96),
                'text_align' => $_POST["layer_{$i}_text_align"] ?? 'center',
                'text_offset_y' => (float)($_POST["layer_{$i}_text_offset_y"] ?? 0.85),
                'text_color' => $_POST["layer_{$i}_text_color"] ?? '#ffffff',
                'text_outline_color' => $_POST["layer_{$i}_text_outline_color"] ?? '#000000',
                'text_outline_width' => (float)($_POST["layer_{$i}_text_outline_width"] ?? 3),
                'text_effect' => $_POST["layer_{$i}_text_effect"] ?? 'none',
                'text_effect_color' => $_POST["layer_{$i}_text_effect_color"] ?? '#00e5ff',
    ...
    try {
        ...
        for ($i = 1; $i <= 8; $i++) {
            ...
            $layerData = [
                ...
                'text_enabled' => isset($_POST["layer_{$i}_text_enabled"]) ? ((int)$_POST["layer_{$i}_text_enabled"] === 1) : ($existingLayer['text_enabled'] ?? false),
                'text_random_style' => isset($_POST["layer_{$i}_text_random"]) ? ((int)$_POST["layer_{$i}_text_random"] === 1) : ($existingLayer['text_random_style'] ?? false),
                'text_random_font' => isset($_POST["layer_{$i}_text_random_font"]) ? ((int)$_POST["layer_{$i}_text_random_font"] === 1) : ($existingLayer['text_random_font'] ?? false),
                'text_random_color' => isset($_POST["layer_{$i}_text_random_color"]) ? ((int)$_POST["layer_{$i}_text_random_color"] === 1) : ($existingLayer['text_random_color'] ?? false),
                'text_random_outline' => isset($_POST["layer_{$i}_text_random_outline"]) ? ((int)$_POST["layer_{$i}_text_random_outline"] === 1) : ($existingLayer['text_random_outline'] ?? false),
                'text_random_effect' => isset($_POST["layer_{$i}_text_random_effect"]) ? ((int)$_POST["layer_{$i}_text_random_effect"] === 1) : ($existingLayer['text_random_effect'] ?? false),
                'text_random_effect_color' => isset($_POST["layer_{$i}_text_random_effect_color"]) ? ((int)$_POST["layer_{$i}_text_random_effect_color"] === 1) : ($existingLayer['text_random_effect_color'] ?? false),
                'text_random_3d' => isset($_POST["layer_{$i}_text_random_3d"]) ? ((int)$_POST["layer_{$i}_text_random_3d"] === 1) : ($existingLayer['text_random_3d'] ?? false),
                'text_random_size' => isset($_POST["layer_{$i}_text_random_size"]) ? ((int)$_POST["layer_{$i}_text_random_size"] === 1) : ($existingLayer['text_random_size'] ?? false),
                'text_random_align' => isset($_POST["layer_{$i}_text_random_align"]) ? ((int)$_POST["layer_{$i}_text_random_align"] === 1) : ($existingLayer['text_random_align'] ?? false),
                'text_content' => isset($_POST["layer_{$i}_text_content"]) ? trim($_POST["layer_{$i}_text_content"]) : ($existingLayer['text_content'] ?? ''),
                'text_font_family' => isset($_POST["layer_{$i}_text_font_family"]) ? $_POST["layer_{$i}_text_font_family"] : ($existingLayer['text_font_family'] ?? '"Bebas Neue", sans-serif'),
                'text_font_size' => isset($_POST["layer_{$i}_text_font_size"]) ? (int)$_POST["layer_{$i}_text_font_size"] : (int)($existingLayer['text_font_size'] ?? 96),
                'text_align' => isset($_POST["layer_{$i}_text_align"]) ? $_POST["layer_{$i}_text_align"] : ($existingLayer['text_align'] ?? 'center'),
                'text_offset_y' => isset($_POST["layer_{$i}_text_offset_y"]) ? (float)$_POST["layer_{$i}_text_offset_y"] : (float)($existingLayer['text_offset_y'] ?? 0.85),
                'text_color' => isset($_POST["layer_{$i}_text_color"]) ? $_POST["layer_{$i}_text_color"] : ($existingLayer['text_color'] ?? '#ffffff'),
                'text_outline_color' => isset($_POST["layer_{$i}_text_outline_color"]) ? $_POST["layer_{$i}_text_outline_color"] : ($existingLayer['text_outline_color'] ?? '#000000'),
                ...
                'text_effect_color' => isset($_POST["layer_{$i}_text_effect_color"]) ? $_POST["layer_{$i}_text_effect_color"] : ($existingLayer['text_effect_color'] ?? '#00e5ff'),
